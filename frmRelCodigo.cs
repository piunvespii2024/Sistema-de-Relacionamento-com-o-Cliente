...
{
    public partial class frmRelCodigo : Form
    {
        public frmRelCodigo()
        {
            InitializeComponent();
        ...
        private void frmRelCodigo_Load(object sender, EventArgs e)
        {
        ...
        private void btPesquisar_Click(object sender, EventArgs e)
        {
            ...
            dataGrid.DataSource = Banco.buscarTodosClientes(true);
            ...
            {
                MessageBox.Show("Sem clientes Cadastrados", "Cadastramento", MessageBoxButtons.OK, MessageBoxIcon.Warning);
